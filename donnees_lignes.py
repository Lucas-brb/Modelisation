...
'Lyon-Roanne' : [list(reversed(Ligne_Roanne_Lyon[0])), [not(_) for _ in Ligne_Roanne_Lyon[1]]], 'StE-Roanne' : [list(reversed(Ligne_Roanne_SaintEtienne[0])), [not(_) for _ in [Ligne_Roanne_SaintEtienne[1]]]], 'StE-Lyon' :
