...
Ligne_Lyon_Macon=[[l9,l8,l7,l6,l20,l21], [False, False, False, False, True, True], all([l9[4],l8[4],l7[4],l6[4],l20[4],l21[4]])]
...
Ligne_Lyon_Annecy=[[l9,l54,l55,l56,l57,l47,l48],[False,True,True,True,True,True,True],all([l9[4],l54[4],l55[4],l56[4],l57[4],l47[4],l48[4]])]
...
troncons_lignes = {'Roanne-Lyon' : Ligne_Roanne_Lyon, 'Roanne-Saint-Etienne' : Ligne_Roanne_SaintEtienne, 'Lyon-Saint-Etienne' : Ligne_Lyon_SaintEtienne, 'Lyon-Macon' : Ligne_Lyon_Macon, 'Lyon-Valence' : Ligne_Lyon_Valence, 'Lyon-Grenoble' : Ligne_Lyon_Grenoble, 'Valence-Grenoble' : Ligne_Valence_Grenoble, 'Grenoble-Chambery' : Ligne_Grenoble_Chambery, 'Chambery-Annecy' : Ligne_Chambery_Annecy, 'Lyon-Bourg-en-Bresse' : Ligne_Lyon_BourgEnBresse, 'Bourg-en-Bresse-Macon' : Ligne_BourgEnBresse_Macon, 'Lyon-Chambery' : Ligne_Lyon_Chambery, 'Lyon-Annecy': Ligne_Lyon_Annecy,'TGV Creusot-Lyon' : TGV_Creusot_Lyon, 'TGV Lyon-Marseille' : TGV_Lyon_Marseille,'TGV Lyon-Montpellier' : TGV_Lyon_Montpellier,'TGV Lille-Grenoble':TGV_Lille_Grenoble,
'Lyon-Roanne' : [list(reversed(Ligne_Roanne_Lyon[0])), list(reversed([not(_) for _ in Ligne_Roanne_Lyon[1]])), Ligne_Roanne_Lyon[2]], 'StE-Roanne' : [list(reversed(Ligne_Roanne_SaintEtienne[0])), list(reversed([not(_) for _ in Ligne_Roanne_SaintEtienne[1]])), Ligne_Roanne_SaintEtienne[2]], 'StE-Lyon' : [list(reversed(Ligne_Lyon_SaintEtienne[0])), list(reversed([not(_) for _ in Ligne_Lyon_SaintEtienne[1]])), Ligne_Lyon_SaintEtienne[2]], 'Macon_Lyon' : [list(reversed(Ligne_Lyon_Macon[0])) , list(reversed([not(_) for _ in Ligne_Lyon_Macon[1]])), Ligne_Lyon_Macon[2]],'Valence-Lyon':[list(reversed(Ligne_Lyon_Valence[0])),list(reversed([not(_) for _ in Ligne_Lyon_Valence[1]])),Ligne_Lyon_Valence[2]],'Grenoble-Lyon':[list(reversed(Ligne_Lyon_Grenoble[0])),list(reversed([not(_) for _ in Ligne_Lyon_Grenoble[1]])),Ligne_Lyon_Grenoble[2]],'Grenoble-Valence':[list(reversed(Ligne_Valence_Grenoble[0])),list(reversed([not(_) for _ in Ligne_Valence_Grenoble[1]])),Ligne_Valence_Grenoble[2]], 'Chambéry-Grenoble':[list(reversed(Ligne_Grenoble_Chambery[0])),list(reversed([not(_) for _ in Ligne_Grenoble_Chambery[1]])),Ligne_Grenoble_Chambery[2]],'Annecy-Chambéry':[list(reversed(Ligne_Chambery_Annecy[0])),list(reversed([not(_) for _ in Ligne_Chambery_Annecy[1]])),Ligne_Chambery_Annecy[2]], 'Bourg-en-Bresse-Lyon':[list(reversed(Ligne_Lyon_BourgEnBresse[0])),list(reversed([not(_) for _ in Ligne_Lyon_BourgEnBresse[1]])),Ligne_Lyon_BourgEnBresse[2]],'Macon-Bourg-en-Bresse':[list(reversed(Ligne_BourgEnBresse_Macon[0])),list(reversed([not(_) for _ in Ligne_BourgEnBresse_Macon[1]])),Ligne_BourgEnBresse_Macon[2]],'Chambery-Lyon':[list(reversed(Ligne_Lyon_Chambery[0])),list(reversed([not(_) for _ in Ligne_Lyon_Chambery[1]])),Ligne_Lyon_Chambery[2]],'Annecy-Lyon':[list(reversed(Ligne_Lyon_Annecy[0])),list(reversed([not(_) for _ in Ligne_Lyon_Annecy[1]])),Ligne_Lyon_Annecy[2]],'TGV Lyon-Creusot':[list(reversed(TGV_Creusot_Lyon[0])),list(reversed([not(_) for _ in TGV_Creusot_Lyon[1]])),TGV_Creusot_Lyon[2]],'TGV Marseille-Lyon':[list(reversed(TGV_Lyon_Marseille[0])),list(reversed([not(_) for _ in TGV_Lyon_Marseille[1]])),TGV_Lyon_Marseille[2]],'TGV Montpellier-Lyon':[list(reversed(TGV_Lyon_Montpellier[0])),list(reversed([not(_) for _ in TGV_Lyon_Montpellier[1]])),TGV_Lyon_Montpellier[2]], 'TGV Grenoble-Lille':[list(reversed(TGV_Lille_Grenoble[0])),list(reversed([not(_) for _ in TGV_Lille_Grenoble[1]])), TGV_Lille_Grenoble[2]]}
...
'Lyon-Roanne', 'StE-Roanne', 'StE-Lyon', 'Macon_Lyon', 'Valence-Lyon', 'Grenoble-Lyon', 'TGV Lyon-Creusot', 'TGV Marseille-Lyon', 'TGV Montpellier-Lyon', 'TGV Grenoble-Lille'


# ['Roanne-Lyon', 'Roanne-Saint-Etienne', 'Lyon-Saint-Etienne', 'Lyon-Macon', 'Lyon-Valence', 'Lyon-Grenoble', 'TGV Creusot-Lyon', 'TGV Lyon-Marseille', 'TGV Lyon-Montpellier', 'TGV Lille-Grenoble']
...
gares_desservables = {'Roanne-Lyon':[gares[2], gares[3], gares[4], gares[5], gares[6]], 'Roanne-Saint-Etienne':[gares[16]],'Lyon-Saint-Etienne':[gares[12],gares[13],gares[14]],'Lyon-Macon':[gares[6],gares[7]],'Lyon-Valence':[gares[35],gares[36],gares[37],gares[38]],'Lyon-Grenoble':[gares[34],gares[33],gares[32],gares[31],gares[30],gares[29],gares[28],gares[27]],'Valence-Grenoble':[gares[40],gares[41],gares[27]],'Grenoble-Chambery':[gares[25],gares[24]],'Chambery-Annecy':[gares[20],gares[21]],'Lyon-Bourg-en-Bresse':[gares[11],gares[10]],'Bourg-en-Bresse-Macon':[],'Lyon-Chambery':[gares[17],gares[18],gares[19],gares[20]],'Lyon-Annecy':[gares[17],gares[18],gares[19],gares[20],gares[21]],'TGV Creusot-Lyon':[],'TGV Lyon-Marseille':[], 'TGV Lyon-Montpellier':[],'TGV Lille-Grenoble':[gares[0]],
'Lyon-Roanne':[gares[2], gares[3], gares[4], gares[5], gares[6]], 'StE-Roanne' : [gares[16]], 'StE-Lyon' : [gares[12],gares[13],gares[14]], 'Macon_Lyon' : [gares[6],gares[7]], 'Valence-Lyon' : [gares[35],gares[36],gares[37],gares[38]], 'Grenoble-Lyon': [gares[34],gares[33],gares[32],gares[31],gares[30],gares[29],gares[28],gares[27]], 'Grenoble-Valence': [gares[40],gares[41],gares[27]], 'Chambéry-Grenoble': [gares[25],gares[24]], 'Annecy-Chambéry' : [gares[20],gares[21]], 'Bourg-en-Bresse-Lyon' : [gares[11],gares[10]], 'Macon-Bourg-en-Bresse' : [], 'Chambery-Lyon' : [gares[17],gares[18],gares[19],gares[20]],'Annecy-Lyon':[gares[17],gares[18],gares[19],gares[20],gares[21]], 'TGV Lyon-Creusot' : [], 'TGV Marseille-Lyon' : [], 'TGV Montpellier-Lyon' : [], 'TGV Grenoble-Lille' : [gares[0]]}



capa_noeuds = {'Lyon':11,'Roanne':3, 'Amplepuis':2, 'Tarare':2, 'Arbesle':4, 'Lozanne':4, 'Saint Germain':4, 'Villefranche':5, 'Mâcon':6, 'Bourg-en-Bresse':7, 'Villars':3, 'Sathonay':4, 'Givors':5, 'Rive de Gier':2, 'Saint Chamond':2, 'Saint Etienne':6, 'Feurs':2, 'Montluel':3, 'Ambérieu':6, 'Culoz':5, 'Aix-les-bains':5, 'Rumilly':2, 'Annecy':5, 'Chambéry':6, 'Montmélian':4, 'Grenoble université':4, 'Grenoble':7, 'Moirans':4, 'Voiron':2, 'Rives':3, 'Saint André':4, 'Tour du Pin':2, 'Bourgoin':3, "Isle d'Abeau":2, 'Vénissieux':3, 'Chasse sur Rhône':4, 'Vienne':5,'Saint Rambert':5, 'Tain':2, 'Valence':7, 'Valence TGV':7, 'Romans':2, 'Oullins':2, 'Saint Just Saint Rambert':2, 'fin tronçon imposé nord':4, 'fin tronçon imposé sud':4,'Lyon Saint Clair':1, 'Pont de Veyle':1, 'Saint-Quentin-Fallavier':1,'Quincieux':1,'Lyon nord':1,'Perrache':2, 'Saint Priest':2,'Saint Hilaire ouest':1,'Saint Hilaire est':1,'Saint Marcelin':1}
#capacité de 1 pour les bifurcations car plusieurs directions possibles donc 1 seul train peut passer
#pour les autre noeuds on met le minimum de nombre de voies entre les 2 côtés du noeud
