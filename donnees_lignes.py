...
capa_noeuds = {'Oullins':2, 'Saint Just Saint Rambert':2, 'fin tronçon imposé nord':4, 'fin tronçon imposé sud':4,'Lyon Saint Clair':1, 'Pont de Veyle':1, 'Saint-Quentin-Fallavier':1,'Quincieux':1,'Lyon nord':1,'Perrache':2, 'Saint Priest':2,'Saint Hilaire ouest':1,'Saint Hilaire est':1,'Saint Marcelin':1}
