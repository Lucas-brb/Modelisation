...
train = [masse(t), RAV_A, RAV_B, RAV_C, v_max, Matrice_vitesse_effort , nbe_passagers, electrique (booléen)]"""
...
tgv = [424 , 6.368 , 0.0755 , 0.001262 , 320 , M_v_e_tgv , 510, True]
...
Ter_2n = [357.5 , 8.028 , 0.1 , 0.001854 , 160 , M_v_e_2n , 570, True]
...
[150 ,82940],
[160 ,77760]])
Ter_regiolis = [294 , 9.931 , 0.1 , 0.002528 , 160 , M_v_e_reg , 228, True]
